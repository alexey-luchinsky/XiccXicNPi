...
public:
    ...
    EvtVector4C WCurrent_KSK(EvtVector4R pKS, EvtVector4R pKplus);
protected:
    ...
    EvtComplex BWKK(double s, int i);
    double pi3G(double Q2);
    EvtComplex pcm(double s);
private:
    static const int nRho = 4;
    double mRho[nRho], gamma0[nRho], cK[nRho];
};
